...
def train(cfg, args):
    ...
    trainer = Trainer(max_steps=cfg.train_params.max_steps, accelerator="gpu", devices="auto", #gpus=1,
...
def test(cfg, args):
    ...
    trainer = Trainer(accelerator="gpu", devices=[3], strategy="ddp", logger=[logger])
...
if __name__ == '__main__':
    ...
    if args.label_path:
        cfg.dataset_SemKITTI.label_path = args.label_path
